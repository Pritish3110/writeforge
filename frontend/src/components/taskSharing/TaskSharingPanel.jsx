...
const readStoredTemplates = () => {
  try {
    const parsed = readStoredJsonValue(TEMPLATE_STORAGE_KEY, []);
...
const writeStoredTemplates = (templates) => {
  writeStoredJsonValue(TEMPLATE_STORAGE_KEY, templates);
};
...
const TaskSharingPanel = ({ tasks, setTasks }) => {
  ...
  const handleDeleteTemplate = async (templateId) => {
    ...
    const shouldDelete = await confirmDelete({
      ...
      description: "This template will be removed from your saved collection and won't be ready the next time you open this panel.",
              ...
              >
                <Card className="rounded-xl glow-border bg-muted/10">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    <p className="text-sm text-muted-foreground">
                      Save this task list so it is easy to bring back later.
                    </p>
                    <Button
                      type="button"
              ...
              <div className="space-y-3">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Keep your favorite task sets close at hand for future projects.
                    </p>
                  </div>
