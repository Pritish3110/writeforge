...
const SIDEBAR_WIDTH = "clamp(13.5rem, 16vw, 17rem)";
...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative h-[calc(100svh-var(--topbar-height))] w-[--sidebar-width] bg-transparent transition-[width] duration-300 ease-in-out",
      ...
      <div
        className={cn(
          "fixed top-[--topbar-height] z-10 hidden h-[calc(100svh-var(--topbar-height))] w-[--sidebar-width] transition-[left,right,width] duration-300 ease-in-out md:flex",
          side === "left"
