...
const Dashboard = () => {
  ...
  const displayName = user ? authDisplayName : getStoredDisplayName();

  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        <p className="text-sm text-muted-foreground">WriterZ</p>
        <h1 className="text-3xl font-bold tracking-tight">
          {getGreeting()}, <span className="text-neon-purple">{displayName}</span>
        </h1>
