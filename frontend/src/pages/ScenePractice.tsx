...
const readStoredDrafts = (): Draft[] => {
  const parsed = readStoredJsonValue<unknown[]>(DRAFT_STORAGE_KEY, []);
  return Array.isArray(parsed)
    ? parsed.map((draft, index) => normalizeDraft(draft, index))
    : [];
};
...
const ScenePractice = () => {
  ...
  useEffect(() => {
    writeStoredJsonValue(DRAFT_STORAGE_KEY, drafts);
  }, [drafts]);
