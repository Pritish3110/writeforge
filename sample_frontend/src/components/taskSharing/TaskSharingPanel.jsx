...
import { WRITEFORGE_TASK_TEMPLATES_KEY } from "@/lib/storageKeys";
...
const TaskSharingPanel = ({ tasks, setTasks }) => {
  ...
  const [storedTemplates, setStoredTemplates] = useLocalStorage(
  ...
  const templates = useMemo(
    () =>
      safeArray(storedTemplates).map((template, index) =>
  ...
  const handleDeleteTemplate = async (templateId) => {
    ...
    const shouldDelete = await confirmDelete({
      ...
      description: "This shared template will be removed from your saved workspace templates and can no longer be reused from the sharing panel.",
              ...
              >
                <Card className="rounded-xl glow-border bg-muted/10">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    <p className="text-sm text-muted-foreground">
                      This saves the current task list to your workspace for quick reuse later.
                    </p>
                    <Button
                      type="button"
              ...
              <div className="space-y-3">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Templates stay attached to your workspace and are ready to reuse across the app.
                    </p>
                  </div>
